...
wget -N https://github.com/upx/upx/releases/download/v${UPX_VERSION}/upx-${UPX_VERSION}-amd64_linux.tar.xz
...
for i in "${!ABIS[@]}"; do
    ...
    && "${UPX_PATH}/upx" --brute --android-shlib -o "${OUT_DIR}/${ABI}/${BIN}" "${OUT_DIR}/unstripped" \
    || exit -1
